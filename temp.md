...
6. The Analytics screen widgets: split by category and split by tags should present top 5 items (and has that high of these 5 items, no scrolls inside of this widget) and the View all button should be available and present the full list of the items (find a good UX friendly way of showing the full list).
