...
- New Python backend MUST be implemented in `/Users/akukharev/src/rnd/money-track/backend_new`.
- Existing C# backend in `/Users/akukharev/src/rnd/money-track/backend` MUST remain unchanged and used as baseline for behavior comparison.
