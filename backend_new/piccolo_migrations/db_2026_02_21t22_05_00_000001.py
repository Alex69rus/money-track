...
async def _create_schema_parity() -> None:
    ...
    statements = [
        ...
        'CREATE INDEX ix_transaction_category_id ON "transaction" (category_id)',
        'CREATE INDEX ix_transaction_transaction_date ON "transaction" (transaction_date)',
        'CREATE INDEX ix_transaction_user_id ON "transaction" (user_id)',
        """
        CREATE UNIQUE INDEX ix_transaction_user_id_message_id
            ON "transaction" (user_id, message_id)
        """,
        """
        CREATE INDEX ix_transaction_user_id_transaction_date
